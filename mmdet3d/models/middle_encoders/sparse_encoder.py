...
class SparseEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        if up_cfg is not None:
            conv_cfg=up_cfg['upsample_cfg']
            norm_cfg=up_cfg['norm_cfg']
            ...
            self.up_module = nn.Sequential(upsample_layer,
            ...
            self.post_block=nn.Sequential(
                ...
                nn.ReLU(inplace=True),
                nn.Conv2d(2*output_channels, output_channels, 3, padding=1),
    ...
    def forward(self, voxel_features, coors, batch_size):
        ...
        if self.up_module is not None:
            spatial_features=self.up_module(spatial_features)
            spatial_features=self.post_relu(spatial_features+self.post_block(spatial_features))        
