...
def forward_test(self, points=None, img_metas=None, img=None, **kwargs):
    ...
    gt_depth_feats=generate_gt_depth_feat(kwargs['gt_depth'],self.loss_depth)
...
def main():
    ...
    torch.save(saved_bev_feats_src,"saved_bev_feats_src.pth")
    torch.save(saved_bev_feats_tgt,"saved_bev_feats_tgt.pth")
