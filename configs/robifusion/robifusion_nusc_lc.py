...
model = dict(
    ...
    pts_middle_encoder=dict(
        type='SparseEncoder',
        in_channels=64,
        sparse_shape=[grid_size[2]+1, grid_size[0], grid_size[1]],
        output_channels=128,
        order=('conv', 'norm', 'act'),
    ...
    bi_fusion_layer=dict(
        ...
        depth_refinement_config={"img_depth_norm":'p2',
                                 "pts_depth_norm":'p2',
                                 "merge_depth_norm":'p2'}
    ),
    ...
    pretrained=dict(
        ...
        pts_voxel_encoder='checkpoints/pretrained_weights/pts_voxel_encoder.pth',
    ),
)
